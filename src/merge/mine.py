...
class labelClickable(QDialog):
    ...
    def initUI(self):
        ...
        self.button1 = QtWidgets.QPushButton('Exit', self)
...
#                                   "border-radius: 8px;font-size:13px;border:1 px solid black;}")
    ...
    def detect(self):
        self.thumbdown=thumbdown_cascade.detectMultiScale(self.gray, 1.1, 5)
    ...
    def detect_2(self):
        self.point=point_cascade.detectMultiScale(self.gray, 1.1, 5)
...
if __name__ == '__main__':
    ...
    face_cascade = cv2.CascadeClassifier('../../rsc/haar_cascades/haarcascade_frontalface_default.xml')

    eye_cascade = cv2.CascadeClassifier('../../rsc/haar_cascades/haarcascade_eye.xml')
