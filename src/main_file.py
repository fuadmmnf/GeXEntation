...
point_cascade = cv2.CascadeClassifier('./haarCascades/point1.xml')
...
fist_cascade=cv2.CascadeClassifier('./haarCascades/fist.xml') # fist
thumbdown_cascade = cv2.CascadeClassifier('./haarCascades/thumbdown.xml')
